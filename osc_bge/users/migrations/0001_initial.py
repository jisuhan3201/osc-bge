    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.CharField(choices=[('bge', 'BGE'), ('agency', 'AGENCY'), ('other', 'Other')], max_length=255, null=True)),
        ...
        migrations.CreateModel(
            name='Counseler',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='counseler', serialize=False, to=settings.AUTH_USER_MODEL)),
