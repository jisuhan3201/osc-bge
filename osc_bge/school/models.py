...
class School(TimeStampedModel):
    ...
    types = models.CharField(max_length=255, choices=SCHOOL_TYPE, null=True, blank=True)
    setting = models.CharField(max_length=255, choices=SETTING_CHOICE, null=True, blank=True)
    founded = models.DateField(null=True, blank=True)
    is_uniform = models.BooleanField()
    is_boarding = models.BooleanField()
    is_communting = models.BooleanField()
    pop_major = models.CharField(max_length=255, null=True, blank=True)
    rep_major = models.CharField(max_length=255, null=True, blank=True)
    club_num = models.IntegerField(null=True, blank=True)
    honor_process = models.CharField(max_length=255, null=True, blank=True)
    ap_process = models.CharField(max_length=255, null=True, blank=True)
    ...
    program_fee = models.DecimalField(max_digits=10, decimal_places=2, blank=True)
    application_fee = models.DecimalField(max_digits=10, decimal_places=2, blank=True)
    boarding_fee = models.DecimalField(max_digits=10, decimal_places=2, blank=True)
