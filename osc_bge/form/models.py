...
class Counsel(TimeStampedModel):
    ...
    current_school = models.CharField(max_length=80, null=True, blank=True)
    ...
    parent_name = models.CharField(max_length=80, null=True, blank=True)
    parent_phone = models.CharField(max_length=140, null=True, blank=True)
    parent_wechat = models.CharField(max_length=140, null=True, blank=True)
    ...
    apply_possibility = models.CharField(max_length=80, null=True, blank=True)
